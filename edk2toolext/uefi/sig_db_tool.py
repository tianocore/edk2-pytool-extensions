...
"""
    ...
    parser.add_argument(
        "--compact", action="store_true", help="Compact, 1 line per data element output for easier diff-ing"
    )
    ...
    parser_get_canonical.add_argument(
        "file", type=str, help="The name of the UEFI Signature Database file to get_canonical"
    )
